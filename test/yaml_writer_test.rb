...
class YamlWriterTest < Minitest::Test
  ...
  def setup_info_for_yaml
    @ex1 = I18n::Extractor.new(file_path("ex1.haml"))
    @ex1.run
  end
  ...
  def test_you_can_pass_a_yaml_file
    yaml_writer = I18n::Extractor::YamlWriter.new(nil, @temp_locale_dir)
  ...
  def test_it_can_accept_a_different_yml_file
    @ex1 = I18n::Extractor.new(file_path("ex1.haml"), {:yaml_file => "/tmp/foo.yml"})
    assert_equal @ex1.yaml_writer.yaml_file, "/tmp/foo.yml"
  end

  def test_it_knows_about_i18n_scope
    @ex1 = I18n::Extractor.new(file_path("ex1.haml"), {:i18n_scope => "he"})
  ...
  def test_it_will_assume_yaml_file_according_to_i18n_scope_if_no_yaml_file_is_passed
    yaml_writer = I18n::Extractor::YamlWriter.new("he", nil)
  ...
  def test_it_will_put_yaml_file_in_appropriate_dir_if_add_filename_prefix_set
    yaml_writer = I18n::Extractor::YamlWriter.new("en", nil, {
  ...
  def test_it_will_not_assume_yaml_file_according_to_i18n_scope_if_yaml_file_is_passed
    yaml_writer = I18n::Extractor::YamlWriter.new("he", "/tmp/foo.yml")
